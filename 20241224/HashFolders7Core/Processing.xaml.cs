...
namespace HashFolders
{
    ...
    {
        private ThreadManager _hasher;
        private System.Windows.Threading.DispatcherTimer _timer;
        private TimeSpan _timespan;
        private object _mutexMessage;

        public Processing(ThreadManager Hasher)
        {
            InitializeComponent();
            _hasher = Hasher;
        ...
        public void Refresh(object sender, EventArgs e)
        {
            ...
            { 
                ...
                _hasher.GetStatistics(out int numFilesProcessed, out int numFoldersProcessed, out int numFilesOutstanding, out int numFoldersOutstanding, out int numThreadsRunning, out int numFilesToDelete);
                if (numFilesOutstanding > 0)
                    lbFilesOutstanding.Content = numFilesOutstanding;
                else
                    lbFilesOutstanding.Content = numFilesToDelete;
